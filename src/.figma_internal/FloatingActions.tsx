import { img, imgVector, imgIconLeft, imgIconLeft1 } from "./svg-em3en";
  ...
  return (
    <div className="bg-white relative rounded-[8px] size-full" data-name="Floating Actions">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex gap-1.5 items-center justify-start p-[4px] relative size-full">
          <UndoAndRedo />
          <SeparatorVertical />
          <MoreButtons />
          <AddStep />
